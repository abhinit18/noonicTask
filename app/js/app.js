...
var App = angular.module('angle', ['ngMask','ui.mask','ngRoute', 'ngAnimate', 'ngStorage', 'ngCookies', 'pascalprecht.translate', 'ui.bootstrap', 'ui.router', 'oc.lazyLoad', 'cfp.loadingBar', 'ngSanitize', 'ngResource', 'ui.utils'])
    .run(["$rootScope", "$state", "$stateParams", '$window', '$templateCache', function ($rootScope, $state, $stateParams, $window, $templateCache) {
        ...
        // -----------------------------------
        $rootScope.app = {
            name: 'BitcoinExchange Dashboard',
            description: 'this is bitcoin dashboard ',
...
App.controller('AppController',
    ['$rootScope', '$scope', '$state', '$translate', '$window', '$localStorage', '$timeout', 'toggleStateService', 'colors', 'browser', 'cfpLoadingBar', "$cookieStore",
 ...
 * Wraps the sidebar and handles collapsed state
 =========================================================*/
App.service('currencyData',function($http,baseurl){
    this.getCurrency = function(){
        return $http({
            method:'GET',
            url:baseurl.url+'ticker'
        }).then(function(data){
            return data;
        })
    }
})
App.service('highChartsConfig', function($http,$cookieStore,baseurl){
